 ...
 *
 * Alter list of available backdrop user targets (fields, properties, etc.)
 ...
 *   'configurable' =>
 *   'configurable_to_backdrop'  0 | 1, is this configurable?
 ...
 *   'direction' => LDAP_USER_PROV_DIRECTION_TO_BACKDROP_USER or LDAP_USER_PROV_DIRECTION_TO_LDAP_ENTRY leave empty if configurable
 ...
 *   Array, the ldap user object relating to the backdrop user.
